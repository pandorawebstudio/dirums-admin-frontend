...
function Page() {
  ...
  const submit = () => {
    fetch(`${BASE_URL}/dashboard/taxes/create/api`, {
      method: 'POST',
      headers: {
  ...
  useEffect(() => {
    if (productCondition === 'name' && page && search2) {
      fetchProducts();
    } else if (productCondition === "category" && page && search2) {
      fetchProductsByCategory();
    } else if (productCondition === "tags" && page && search2) {
      fetchProductsByTags();
    } else if (productCondition === "vendor" && page && search2) {
      fetchProductsByVendors();
    }
  }, [productCondition, page, search2]);
      ...
      <div className="my-10">
        <Card>
          <CardBody>
            ...
            <Input label="name" containerProps={{ className: "my-3" }} onInput={(e) => setName(e.target.value)} />
            <Input label="HSN Code" containerProps={{ className: "my-3" }} onInput={(e) => setHSN(e.target.value)} />
            <Input label="Tax Rate" containerProps={{ className: "my-3" }} onInput={(e) => setPercentage(e.target.value)} />
